...
import { getEventById, getRelatedEvents } from '../data/eventData';
...
const EventDetailPage: React.FC = () => {
  ...
  const ticketTypes = [
    ...
    },
    {
      id: 't2',
      name: 'VIP Access',
      price: Math.round(event.price.min * 2.5),
          ...
          <div className="lg:col-span-2">
            ...
            {relatedEvents.length > 0 && (
              <div className="bg-white rounded-2xl shadow-sm p-6">
                <h2 className="text-2xl font-bold text-text mb-6">Related Events</h2>
                    ...
                    {ticketTypes.map((ticket) => (
                      ...
                      >
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <span className="font-medium text-lg text-text">${ticket.price}</span>
                        </div>
                ...
                <div className="border-t border-neutral-100 pt-4">
                  ...
                  <div className="flex justify-between mb-4">
                    ...
                    <span className="font-bold text-lg text-text">
                      ${selectedTickets * ticketTypes[0].price}
                    </span>
                  </div>
                  
                  <button
                    className={`btn w-full ${
                      selectedTickets > 0 ? 'btn-primary' : 'bg-neutral-200 text-neutral-500 cursor-not-allowed'
                    }`}
