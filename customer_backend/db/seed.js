import { Event, EventDescription, Ticket, Order, User } from "../models/mongo/index.js";
    ...
    const eventDescriptions = await EventDescription.insertMany([
      {
        ...
        event_image: "https://images.pexels.com/photos/1105666/pexels-photo-1105666.jpeg",
      ...
      },
      {
        ...
        event_image: "https://images.pexels.com/photos/2582937/pexels-photo-2582937.jpeg",
        event_date: new Date("2025-09-20"),
        event_description: "The biggest tech conference of the year with keynotes from industry leaders.",
        event_location: "Convention Center, San Francisco"
      },
      {
        event_desc_id: uuidv4(),
        event_name: "Food & Wine Expo",
        event_image: "https://images.pexels.com/photos/541216/pexels-photo-541216.jpeg",
        event_date: new Date("2025-08-05"),
        event_description: "Taste incredible dishes and wines from renowned chefs and sommeliers.",
      ...
      },
      {
        ...
        event_description: "The final championship game of the season featuring top teams.",
    ...
    await Order.insertMany([
      {
        ...
        email: users[0].email,
        tickets_bought: [
          { ticket_id: tickets[0].ticket_id, quantity: 2 }
        ],
